...
<html lang="en">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="{{URL::asset('assets/css/theme-default/libs/rickshaw/rickshaw.css?1422792967')}}" />
		<link type="text/css" rel="stylesheet" href="{{URL::asset('assets/css/theme-default/libs/morris/morris.core.css?1420463396')}}" />
		<!-- END STYLESHEETS -->
